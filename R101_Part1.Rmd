...
A note before getting started: This tutorial is written in RMarkdown in order to provide formatted alongside the sample code. You have two option for following along: 1) Download this RNotebook file, save to your local computer, and write directly in the code blocks or 2) Open a new R Script, copy-paste the relevant code blocks, and edit as needed.
